...
export function ClientGateways() {
  ...
  const { mutate: createNewGateway, isLoading: createNewGatewayLoading } =
    useCreateNewGateway(() => {
...
function GatewayOption({
  ...
  const {
    ...
    isLoading: createVirtualAccountLoading,
  } = useCreateVirtualAccount();
  const [createVirtualAccountModalOpen, setCreateVirtualAccountModalOpen] =
    useState(false);
    ...
    <>
      {createVirtualAccountModalOpen && (
        <CreateVirtualAccountModal
          createVirtualAccountModalOpen={createVirtualAccountModalOpen}
          setCreateVirtualAccountModalOpen={setCreateVirtualAccountModalOpen}
