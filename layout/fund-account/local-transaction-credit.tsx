  ...
  return (
    <Group spacing="xl" py={0} className="h-full">
      <form
        ...
        onSubmit={localTransactionCreditForm.onSubmit(handleLocalFormSubmit)}
      >
        <LoadingOverlay
          visible={
            // bankDetailsLoading ||
        ...
        <Stack spacing="xs">
          <Select
            ...
            {...localTransactionCreditForm.getInputProps("source_account")}
          />
          <Select
                ...
                <>
                  <div className="text-center">
                    <Pill
                      ...
                      )}${currencyFormatter(transactionCharges.data.charges)}`}
                      color="bg-gray-200"
                    />
                  </div>
                  <NumberInput
                    ...
                    {...localTransactionCreditForm.getInputProps("unit")}
                  />
          ...
          <Button
            ...
            loading={
              loadTansactionCreditLoading || loadingTransactionCharges
            }
